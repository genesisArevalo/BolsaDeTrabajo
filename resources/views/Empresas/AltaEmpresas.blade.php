...
<nav class="navbar navbar-dark navbar-full" style="background-color:#18386B">
 ...
 <div class="col-md-4 order-md-2 mb-4">
    ...
    <form action="{{route('empresa-add')}}" method="POST">
               @csrf
       ...
       <h5 class="mb-3">Informacion de la empresa</h5>
          ...
          <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="nom_responsable" class="form-control" id="firstName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{2,35}" required>
                <div class="invalid-feedback">
              ...
              <div class="col-md-4 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="app_p" class="form-control" id="lastName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,]{2,20}" required>
                <div class="invalid-feedback">
               ...
               <div class="col-md-4 mb-3">
                ...
                <input type="text" name="app_m" class="form-control" id="secondlastName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,]{2,20}" required>
                <div class="invalid-feedback">
                  Valid last name is required.
                </div>
              </div>
