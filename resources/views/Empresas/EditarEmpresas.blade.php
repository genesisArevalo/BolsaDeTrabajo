    ...
    BOLSA DE TRABAJO
       ...
       <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
         <li class="nav-item active">
          <a class="nav-link" href="{{route('welcome-home')}}" style="">Panel administrativo<span class="sr-only">(current)</span></a>
         </li>
       </ul>
       ...
       <h5 class="mb-3">Informacion de la empresa</h5>
          @foreach($empresas as $empresa)
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="telefono" class="form-control" id="telefono" placeholder="(962) 62 51723" value="" maxlength="13" pattern="[0-9]{10}" required>
                <div class="invalid-feedback">
              ...
              <img src="/images/Location-company.png" width="30" height="30" class="d-inline-block align-top" alt="">
                ...
                <input type="text" name="localidad" class="form-control" id="Localidad" placeholder="" value=""   pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,15}" required>
                <div class="invalid-feedback">
              ...
              <div class="mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="ubicacion" class="form-control" id="ubicacion" placeholder="" value=""  required>
                <div class="invalid-feedback">
           ...
           <img src="/images/email.svg" width="30" height="30" class="d-inline-block align-top" alt="">
              ...
              <input type="email" name="email" class="form-control" id="email" placeholder="Mi_Empresa@example.com">
              <div class="invalid-feedback">
          ...
          <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="nom_responsable" class="form-control" id="firstName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{2,15}" required>
                <div class="invalid-feedback">
              ...
              <div class="col-md-4 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="app_p" class="form-control" id="lastName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{2,15}" required>
                <div class="invalid-feedback">
               ...
               <div class="col-md-4 mb-3">
                ...
                <input type="text" name="app_m" class="form-control" id="secondlastName" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{2,15}" required>
                <div class="invalid-feedback">
                  Valid last name is required.
                </div>
              </div>
               ...
               <div class="col-md-8 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="cargo" class="form-control" id="Cargo" placeholder="" value=""  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,35}" required>
                <div class="invalid-feedback">
         ...
         <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <label for="inputApellidoPaterno4" style=" color:red">*</label>
                <input type="text" name="horario" class="form-control" id="horario" placeholder="09:00-13:00" value=""required>
                <div class="invalid-feedback">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="salario" class="form-control" id="salario" placeholder="" value="" required>
                <div class="invalid-feedback">
